                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">TÀI SẢN PHÒNG BAN</h5>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mt-2-lg-0 d-flex align-items-center">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Tìm tài sản theo tên" id="search-input">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-2 col-lg-2 col-xl-2">                        
                            <button class="btn form-control btn-primary" data-value="assets/add" type="button" name="add" disabled>
                    ...
                    <div class="row p-3 align-items-center">
                        <div class="col-sm-3 text-secondary">
                            ...
                            <a href="javascript:void(0)" class="dropdown-toggle text-dark font-weight-bold" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Chọn</a>
                            <div class="dropdown-menu departmentFilter">
                        ...
                        <div class="col-sm-3 text-secondary">
                            <i class="fas fa-sitemap mr-2"></i>Loại tài sản:
                            ...
                            <div class="dropdown-menu filter">
                                ...
                                <c:forEach var="assetType" items="${assetTypes}">
                                    <a class="dropdown-item" href="javascript:void(0)" data-value="${assetType.id}">${assetType.name}</a>
                                </c:forEach>
                            </div>
                        </div>
                        <div class="col-sm-1 offset-sm-5 text-secondary text-center">
                        ...
                        <table class="table table-hover">
                            <thead class="sticky-top">
                                <tr class="text-primary">
                                    <th class="col-2 text-center">Mã tài sản</th>
                                    <th>Tên</th>
                                    <th>Đơn vị tính</div>
                                    <th>Loại tài sản</div>
                                    <th>Số lượng</div>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="asset" items="${assetWithQuantityList}">
                                    <tr>
                                        <td class="text-center">${asset.asset.id}</td>
                                        <td>${asset.asset.name}</td>
                                        <td>${asset.asset.unit}</td>
                                        <td class="index">${asset.asset.assetType.name}</td>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(assetWithQuantities)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
