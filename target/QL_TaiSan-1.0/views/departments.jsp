                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">DANH MỤC PHÒNG BAN</h5>
                        </div>
                    ...
                    <div class="row p-3">
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right text-secondary">
                        ...
                        <table class="table table-hover">
                            <thead class="sticky-top">
                                <tr class="text-primary">
                                    <th class="col-2 text-center">Mã phòng ban</th>
                                    <th class="col-10">Tên</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(departments)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
