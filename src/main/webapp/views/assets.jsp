                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">DANH MỤC TÀI SẢN</h5>
                        </div>
                    ...
                    <div class="row p-3 align-items-center">
                        <div class="col-md-6 col-sm-6 col-12 text-secondary">
                            ...
                            <div class="dropdown-menu filter">
                                ...
                                <c:forEach var="assetType" items="${assetTypes}">
                                    <a class="dropdown-item border-bottom" href="javascript:void(0)" data-value="${assetType.id}">${assetType.name}</a>
                                </c:forEach>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-12 text-right text-secondary">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="asset" items="${assets}">
                                    <tr>
                                        ...
                                        <td><img src="${asset.image}" alt=" "/></td>
                                        <td>${asset.name}</td>
                                        <td>${asset.weight}</td>
                                        <td>${asset.unit}</td>
                                        <td>${asset.price}</td>
                                        <td>${asset.percentageDepreciation}</td>
                                        <td class="index">${asset.assetType.name}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(assets)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
