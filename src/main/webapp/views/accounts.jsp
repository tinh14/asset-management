                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">DANH MỤC TÀI KHOẢN</h5>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mt-2-lg-0 d-flex align-items-center">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Tìm theo tên đăng nhập" id="search-input">
                            </div>
                        </div>
                    ...
                    <div class="row p-3 align-items-center">
                        <div class="col-md-6 col-sm-6 col-xs-12 text-secondary">
                            <i class="fa fa-lock mr-2"></i></i>Trạng thái:
                            ...
                            <div class="dropdown-menu filter">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)" data-value="1">Hoạt động</a>
                                <a class="dropdown-item" href="javascript:void(0)" data-value="0">Khóa</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="account" items="${accounts}">
                                    <tr>
                                        ...
                                        <td class="index"><c:if test="${account.status == true}">Hoạt động</c:if><c:if test="${account.status == false}">Khóa</c:if></td>
                                            <td></td>
                                        </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(accounts)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
