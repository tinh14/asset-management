                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">TỒN KHO ĐƠN VỊ</h5>
                        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="assetWithQuantity" items="${assetWithQuantityList}">
                                    <tr>
                                        <td class="text-center">${assetWithQuantity.asset.id}</td>
                                        <td><img src="${assetWithQuantity.asset.image}" alt=" "/></td>
                                        <td>${assetWithQuantity.asset.name}</td>
                                        <td>${assetWithQuantity.asset.unit}</td>
                                        <td class="index">${assetWithQuantity.asset.assetType.name}</td>
                                        <td>${assetWithQuantity.quantity}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(assetWithQuantityList)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
