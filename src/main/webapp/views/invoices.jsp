                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">DANH MỤC HÓA ĐƠN</h5>
                        </div>
                    ...
                    <div class="row p-3 align-items-center">
                        <div class="col-lg-4 col-md-4 text-secondary">
                            <i class="fas fa-user-tie mr-2"></i></i>Nhà cung cấp:
                            ...
                            <div class="dropdown-menu filter">
                                ...
                                <c:forEach var="supplier" items="${suppliers}">
                                    <a class="dropdown-item" href="javascript:void(0)" data-value="${supplier.id}">${supplier.name}</a>
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr class="text-primary">
                                    <th class="col-2 text-center">Mã hóa đơn</th>
                                    <th>Số hóa đơn</th>
                                    <th>Ngày lập</div>
                                    <th>Nhà cung cấp</div>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="invoice" items="${invoices}">
                                    <tr>
                                        ...
                                        <td class="dateIndex"><fmt:formatDate value="${invoice.invoiceDate}" pattern="dd/MM/yyyy"/></td>
                                        <td class="index">${invoice.supplier.name}</td>
                                    </tr> 
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(invoices)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
