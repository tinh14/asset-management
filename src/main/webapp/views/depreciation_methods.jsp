...
<html>
    <head>
        ...
        <title>Phương pháp khấu hao</title>
    </head>
    <body>
                ...
                <div class="form-wrapper">
                    <div class="row p-3 border-bottom" id="control-div">
                        ...
                        <div class="col-9 col-sm-9 col-md-4 col-lg-6 col-xl-6">
                            <h5 class="text-primary">PHƯƠNG PHÁP KHẤU HAO</h5>
                        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="depreciationMethod" items="${depreciationMethods}">
                                    <tr>
                                        <td class="text-center">${depreciationMethod.id}</td>
                    ...
                    <div class="row mt-2 justify-content-end">
                        ...
                        <div class="col-sm-6 text-secondary text-right mr-3">
                            Tổng số <span id="numRecords">${fn:length(depreciationMethods)}</span> bản ghi
                        </div>
                    </div>
                </div>
            </div>
